    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 mb-4">
          ...
          <img class="card-img-top" src="img/ubicacion.jpg" alt="">
        </div>
        ...
        <div class="col-lg-4 mb-4">
          ...
          <p>
            ...
            <a href="mailto:fdxprogrammer@gmail.com">fdxprogrammer@gmail.com</a>
          </p>
          <p>
      ...
      <div class="row">
        <div class="col-lg-8 mb-4">
          <h3>Contacto</h3>
          <form name="sentMessage" id="contactForm1" method="POST" action="mail/contact_me.php" novalidate>

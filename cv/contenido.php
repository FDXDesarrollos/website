...
$html = <<<EOF
    ...
    <table>
        ...
        <tr>
            <td><b>Dirección: </b> &nbsp;Acueducto No.13 Col. San Pedro Zacatenco GAM CDMX</td>
        </tr>
        <tr>
            <td><b>Años cursados: </b> &nbsp;3</td>
        </tr>
        <tr>
            <td><b>Fecha de termino: </b> &nbsp;T&iacute;tulo y C&eacute;dula Profesional</td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
        ...
        <tr>
            <td><b>Dirección: </b> &nbsp;Cerrada de San Bartolo s/n col. Ampliación Vicente Villada. Cd. Nezahualcóyotl Edo. Méx.</td>
        </tr>
        <tr>
            <td><b>Años Cursados: </b> &nbsp;3</td>
        </tr>
    ...
    <table>
        <tr>
            <td>
                <ul>
                    <li>Diseño de Páginas web dinámicas con HTML5, CSS3 y jQuery.</li>
                    <li>Desarrollo de Aplicaciones Web con PHP 7 y MySQL</li>
                    <li>Programación de Videojuegos 2D con C/C++</li>
                </ul>
            </td>
        </tr>
    </table>
   ...
   <table>
        <tr>
            <td><b>Lenguajes: </b> &nbsp;Java, PHP, Python, C#, VB.Net, C/C++, JavaScript, HTML5 y CSS3.</td>
        </tr>
        <tr>
            <td><b>Framewoks: </b> &nbsp;Codelgniter 3, jQuery y Bootstrap. (Learning Spring Boot)</td>
        </tr>
        <tr>
            <td><b>Bases de Datos: </b> &nbsp;MySQL, SQLServer y Access.</td>
        </tr>
        <tr>
            <td><b>IDE's: </b> &nbsp;NetBeans, CodeBlocks  y Visual Studio 2010.</td>
        </tr>
        <tr>
            <td><b>Sistemas Operativos: </b> &nbsp;Ubuntu Linux 20.04 LTS, Fedora Linux 34, Windows 7 y 8.</td>
        </tr>
        <tr>
            <td><b>Ofimática: </b> &nbsp;LibreOffice Community 7.4 y Microsoft Office 2007.</td>
        </tr>        
        <tr>
